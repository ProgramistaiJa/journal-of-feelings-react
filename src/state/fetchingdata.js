...
// action types
const FETCH__BEGIN = 'entries/FETCH__BEGIN'
const FETCH__SUCCESS = 'entries/FETCH__SUCCESS'
const FETCH__FAIL = 'entries/FETCH__FAIL'
...
export default (state = initialState, action = {}) => {
  switch (action.type) {
    ...
    case ADD:
      return {
        ...state,
        data: [action.entry].concat(state.data)
      }
